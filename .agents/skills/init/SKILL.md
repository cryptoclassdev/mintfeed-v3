---
name: init
description: Initialize AGENTS.md documentation for a codebase. Use when setting up a new repository for AI coding assistants, creating project documentation for Codex or Cursor, or improving existing AGENTS.md files.
---
...
This file provides guidance to Codex (Codex.ai/code) and Cursor IDE (https://cursor.com) when working with code in this repository.
```

## Also Create AGENTS.md

Create a file called `AGENTS.md` with:
```
@AGENTS.md
```
